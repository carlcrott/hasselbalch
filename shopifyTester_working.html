...
}; // end var hhScript = function($){


// shopify implementation per:
// http://docs.shopify.com/api/unlinked/using-javascript-responsibly
...
// ]]>
  ...
  <style type="text/css">
      ...
      table tr td:first-child, table tr th:first-child, .tg_calc { padding:10px 15px; }
